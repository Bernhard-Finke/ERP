...
# to calculate these graphs from scratch please install the package "AnNet" available from https://github.com/lptolik/AnNet/ and follow these steps (example given for presynaptic graph):
...
# To recalculate disease interactions, for a given cluster graph (gg), use the following command from AnNet (this 
# specific command includes the diseases AD, BD, AUT, and Epi):
...
inputPanel(
  ...
  selectInput(
    inputId = "down3f",
    label = "Choose download",
    choices = c("Figure (proteins by cluster and disease association)" = "Figure","Table (p-value by cluster)" = "Table"),
    selected = "Graph",
    multiple = FALSE
  ),
